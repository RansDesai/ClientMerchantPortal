...
var QuickSidebar = function () {
    ...
    var handleQuickSidebarToggler = function () {
		...
		$('.top-menu .dropdown-quick-sidebar-toggler a, .Announcements > .dropdown-toggle').click(function (e) {
			...
			setTimeout(function () {
				$('.AnnouncementHeaderSection > .dropdown-toggle').dropdown();
			}, 100);
        });
        //$('.top-menu .dropdown-quick-sidebar-toggler a, .page-quick-sidebar-toggler').hover(function (e) {
        ...
        //                $('body').trigger('updateReportShortcutMenu');
        //            }, 300);
        //            // save timer
        ...
        //    } 
        //});
		$('.page-quick-sidebar-wrapper').mouseleave(function (e) {
            setTimeout(function () {
