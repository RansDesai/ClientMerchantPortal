/**
Theme script to handle the theme changes
**/
var Theme = function() {
    ...
    var handleTheme = function() {
        ...
        var setColor = function(color) {
            ...
            if (color == 'light2') {
                $('.page-logo img').attr('src', Layout.getLayoutImgPath() + logo);
            } else {
                $('.page-logo img').attr('src', Layout.getLayoutImgPath() + logo);
            }
            ...
            if (typeof (Storage) !== "undefined") {
                ...
                localStorage.setItem("RMS-ThemeColor", color);
            } else {
                // Sorry! No Web Storage support ... persist to server
                var client = {
                    ThemeColor: color
                };
    ...
    return {
        ...
        update: function () {
            if (typeof (Storage) !== "undefined") {
                // Code for localStorage/sessionStorage.
                var color = localStorage.getItem("RMS-ThemeColor");
                if (color != undefined) {
                    var color_ = (Metronic.isRTL() ? color + '-rtl' : color);
                    $('#style_color').attr("href", Layout.getLayoutCssPath() + 'themes/' + color_ + ".css");
                }
