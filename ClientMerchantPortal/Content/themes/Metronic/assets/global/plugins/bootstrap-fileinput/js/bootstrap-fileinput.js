...
/* RMS Edits:
 * - 2020-07-08: Added "browseOnCaptionClick", functioning like browseOnZoneClick
 */
(function (factory) {
    'use strict';
    ...
    FileInput.prototype = {
        ...
        _init: function (options, refreshMode) {
            ...
            self.captionClickable = self.browseOnCaptionClick && self.showCaption;
        ...
        _initClickable: function () {
            ...
            if (self.captionClickable) {
                $zone = self.$captionContainer;
                $h.addCss($zone, 'clickable');
                $zone.attr('tabindex', -1);
                self._handler($zone, 'click', function (e) {
                    var $tar = $(e.target);
